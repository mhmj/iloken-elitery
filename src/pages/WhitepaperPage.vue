    ...
    <section class="hero">
      <div class="container">
        <div class="hero-content">
          <div class="hero-text">
            <h1>Whitepaper</h1>
            <p>Explore key industry challenges, trends, and solutions—all in one comprehensive whitepaper.</p>
          </div>
      ...
      <div class="container">
        ...
        <div class="search-bar">
          <div class="search-input">
            <input type="text" placeholder="Search whitepaper" v-model="searchQuery">
        ...
        <div class="whitepapers-grid">
          ...
          >
            ...
            <div class="whitepaper-content">
              <div class="whitepaper-date">{{ whitepaper.date }}</div>
              <h3 class="whitepaper-title">{{ whitepaper.title }}</h3>
              <p class="whitepaper-description">{{ whitepaper.description }}</p>
...
export default {
  ...
  data() {
    return {
      ...
      whitepapers: [
        {
          id: 1,
          title: 'Securing the Digital Enterprise: A Practical Guide to Cyber Resilience',
  ...
  computed: {
    filteredWhitepapers() {
      if (!this.searchQuery) return this.whitepapers;
      
      return this.whitepapers.filter(whitepaper =>
        whitepaper.title.toLowerCase().includes(this.searchQuery.toLowerCase()) ||
